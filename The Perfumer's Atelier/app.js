...
pages.fragrance = function () {
  ...
  function render() {
    ...
    m.innerHTML =
      ...
      '<article class="fr">' +
        '<div class="fr-visual">' +
          '<div class="fr-photo"><img src="img/' + f.photo + '.jpg" alt="' + esc(NOTES[f.notes.heart[0]].name) + '" onerror="this.style.display=\'none\'">' +
            '<span class="fr-bottle">' + bottleSVG(FAMILIES[f.family].hue, { cls: "big" }) + '</span></div>' +
          '<p class="fr-photo-cap">Specimen: ' + esc(NOTES[f.notes.heart[0]].latin) + '</p>' +
        '</div>' +
        '<div class="fr-info">' +
