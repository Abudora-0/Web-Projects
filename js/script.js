...
const PROJECTS = [
  ...
  { slug: "deep-six", name: "Sapper", cat: "game", accent: "#1084d0", built: "2026-09",
    tagline: "Minesweeper the way Windows 95 shipped it.",
    sig: "Smiley, LED counters, chording", tags: ["First-click safe", "Chording", "Best times"] },
  { slug: "dry-dock", name: "Tetrograd", cat: "game", accent: "#ffb000", built: "2026-09",
    tagline: "Tetris on a Soviet lab terminal, 1984.",
    sig: "Pieces are [ ] brackets", tags: ["VT323 phosphor", "7-bag", "Hold + ghost"] },
  ...
  { slug: "specimen", name: "Specimen", cat: "tool", accent: "#e2483d", built: "2026-09",
    ...
    sig: "Compare, OpenType, waterfall", tags: ["Google Fonts", "Compare mode", "OpenType"] },
  { slug: "slipbox", name: "Slipbox", cat: "tool", accent: "#a9762f", built: "2026-09",
    tagline: "Notes as index cards in a card catalogue.",
    sig: "Bracket links + backlinks", tags: ["Markdown-lite", "Wikilinks", "Quick-open"] },
